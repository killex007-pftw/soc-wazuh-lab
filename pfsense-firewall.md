...
> [!**NOTA IMPORTANTE**]: Lo desarrollado en todo este apartado pertenece a la configuración base de pfsense. En fases posteriores, documentadas respectivamente en el apartado [docs](./docs), se añadieron reglas a pfsense para acoplar a los objetivos desplegados en cada escenario.
